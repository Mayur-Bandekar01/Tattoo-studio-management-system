...
INSERT INTO `artist` VALUES ('DRAG-ART-001','Arjun Mehta','arjun@dragon.com','Artist@123','9876543210','Tattoo Artist','2026-03-13 19:30:33',NULL),('DRAG-ART-002','Priya Sharma','priya@dragon.com','Artist@456','9876543211','Sketch Artist','2026-03-13 19:30:33',NULL),('DRAG-ART-003','Rahul Verma','rahul@dragon.com','Artist@789','9876543212','Laser Removal Specialist','2026-03-13 19:30:33',NULL);
...
INSERT INTO `customer` VALUES (1,'Venom','venomousbeast107@gmail.com','Venom@123','1111111111','','2026-03-13 19:37:33'),(2,'Jonathan Baker','jonathanbaker@gmail.com','Jonathan@123','6121868868','_jonathan_baker_','2026-03-14 13:33:41'),(3,'Mayur','mayurbandekar480@gmail.com','Mayur@123','6360174312','','2026-03-17 17:29:18'),(4,'Daria Pratt','Daria@gmail.com','Daria@123','7485694152','','2026-03-22 12:43:31'),(5,'Test Customer','testcustomer@example.com','Password123!','1234567890','','2026-04-25 19:53:26'),(6,'Debug Customer','debug@example.com','Password123!','9876543210','','2026-04-26 15:03:53'),(7,'Test Customer','test@customer.com','Password123!','1234567890','','2026-04-26 15:41:46'),(8,'Test User','test@example.com','Password123!','1234567890','','2026-04-27 10:38:51'),(9,'Test User Two','test2@example.com','Password123!','1234567891','','2026-04-27 10:41:21'),(10,'vishal benni','vishalbennni@gmail.com','Vishal@123','9945874314','_vishal_benni_','2026-05-04 19:02:35');
...
CREATE TABLE `gallery_likes` (
  ...
  CONSTRAINT `gallery_likes_ibfk_1` FOREIGN KEY (`gallery_id`) REFERENCES `gallery` (`gallery_id`) ON DELETE CASCADE,
  CONSTRAINT `gallery_likes_ibfk_2` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `inventory_usage` VALUES (1,11,37,0.98,'DRAG-ART-002','2026-04-21 13:01:38'),(2,1,3,100.00,'DRAG-ART-001','2026-05-04 15:43:25');
...
INSERT INTO `owner` VALUES (1,'Dragon Owner','owner@dragon.com','Owner@123','9999999999','2026-03-13 19:30:24',100000.00);
...
--
-- Table structure for table `studio_owner`
--

DROP TABLE IF EXISTS `studio_owner`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `studio_owner`
--

LOCK TABLES `studio_owner` WRITE;
/*!40000 ALTER TABLE `studio_owner` DISABLE KEYS */;
INSERT INTO `studio_owner` VALUES (1,'Admin Owner','darkdragon.ink@gmail.com','mayu@123');
/*!40000 ALTER TABLE `studio_owner` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `usage_log` (
  ...
  CONSTRAINT `usage_log_ibfk_1` FOREIGN KEY (`appointment_id`) REFERENCES `appointment` (`appointment_id`) ON DELETE CASCADE,
  CONSTRAINT `usage_log_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `inventory` (`item_id`) ON DELETE CASCADE,
  CONSTRAINT `usage_log_ibfk_3` FOREIGN KEY (`artist_id`) REFERENCES `artist` (`artist_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'dragon_tattoos'
--
...
-- Dump completed on 2026-05-07 21:11:13
